...
330 controls, each with exactly one conclusion. Terminal: 266. Open: 64.

| conclusion | controls |
|---|---|
| DIRECT_UI_CONFIRMED | 172 |
| HOST_TEXT_VALIDATED | 40 |
| UI_OBSERVABLE_BUT_UNREADABLE | 37 |
| HOST_TEXT_UNVALIDATED (open) | 36 |
| NEEDS_CONTEXT (open) | 12 |
| UI_MISMATCH | 11 |
| NEEDS_REREAD (open) | 9 |
...
**NEEDS_CONTEXT (12)**: `lfo1.rate_10x`, `lfo1.swing`, `lfo2.rate_10x`, `lfo2.swing`, `lfo3.rate_10x`, `lfo3.swing`, `lfo4.rate_10x`, `lfo4.swing`, `lfo5.rate_10x`, `lfo5.swing`, `lfo6.rate_10x`, `lfo6.swing`
